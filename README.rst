Compliance Document & Expiry Management for Odoo 17
=====================================================
...
* Odoo 17.0 Community or Enterprise, Odoo.sh, or self-hosted Odoo.
* Standard Odoo dependencies: Contacts and Discuss/Mail.
* Use the dedicated ``17.0`` branch. Separate version branches provide the
